...
<section className="max-w-[1420px] bg-white mx-auto py-12 lg:py-24 border-b-2 border-gray-1">
  <div className="max-w-[1600px] mx-auto flex flex-col lg:flex-row items-start justify-between px-4 gap-8">
    <div className="lg:w-[500px]">
      <h1 className="text-[28px] sm:text-[36px] lg:text-[58px] leading-tight font-semibold text-left">
        Ako správne vykonať <br /> dentálnu hygienu
      </h1>
      <p className="text-[#736E69] lg:text-left text-sm sm:text-base mt-4">
